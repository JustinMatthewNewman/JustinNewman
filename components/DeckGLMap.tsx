...
export default function DeckGLMap({
  ...
  const MAP_STYLE = theme === lightTheme ? "https://basemaps.cartocdn.com/gl/positron-gl-style/style.json" : "https://basemaps.cartocdn.com/gl/dark-matter-gl-style/style.json";
  const COLOR = theme === lightTheme ? colorRange2 : colorRange;
  let sem = 0;
  ...
  const layers = [
    ...
    new ScatterplotLayer({
      ...
      getColor: theme === lightTheme ? [255, 25, 20] : [252, 89, 252],
      elevationScale: 3,
...
export function renderToDOM(container: HTMLElement) {
  ...
  csv(DATA_URL, (error, response) => {
    if (!error) {
      ...
      console.log(data);
      root.render(<DeckGLMap data={data} />);
    }
  });
}