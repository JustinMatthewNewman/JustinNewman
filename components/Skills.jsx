    ...
    <div id='skills' className='w-full p-4 flex justify-center'>
      ...
      <Grid style={{zIndex: 2}}>
        <Collapse.Group shadow style={{ backgroundColor: `${theme.sidenav}`, color: `${theme.text}`,  }}>
          <Collapse
            title={<Text h4 style={{ color: `${theme.text}` }}>Python 3</Text>}
          ...
          <Collapse
            title={<Text h4 style={{ color: `${theme.text}` }}>Java</Text>}
          ...
          >
            <Text style={{ color: `${theme.text}` }}>
            I developed a Java application that interacted with external systems to fetch and process athletic statistics for teams. The application utilized the Jsoup library to scrape player stats from websites in a quick and efficient manner. I implemented a custom parser using Jsoup to extract relevant data from the HTML documents. The retrieved statistics were then rendered onto ESPN-style graphic cards with custom colors representing the respective university. The Java application provided a streamlined process for gathering and displaying team athletic statistics, saving significant time and effort.
            </Text>
          </Collapse>
          <Collapse
            title={<Text h4 style={{ color: `${theme.text}` }}>x86</Text>}
          ...
          >
            <Text style={{ color: `${theme.text}` }}>
            In CS470 Parallel and Distributed systems, I gained experience in optimizing software performance through low-level systems understanding. I utilized technologies like OpenMP, MPI, and CUDA to exploit parallelism and utilize hardware resources effectively. By leveraging multiple threads, processes, and GPU cores, I improved the performance of computationally intensive tasks. This low-level optimization allowed me to achieve significant speedup in the execution of algorithms and simulations. The analysis work from these projects are posted on my resume sections.
            </Text>
          </Collapse>
          <Collapse
            title={<Text h4 style={{ color: `${theme.text}` }}>React</Text>}
          ...
          >
            <Text style={{ color: `${theme.text}` }}>
            As a Junior Software Engineer at Metalinguist LLC, I successfully managed state, component hierarchy, and data flow within the React-based client portal and digital storefront for the translation industry. Contributions include implementing an administrative reporting dashboard, following Apple HIG design guidelines, and utilizing React.js and CSS for UI enhancements. I collaborated effectively in a remote environment using agile methodologies, provided creative solutions leveraging higher-order functions, strengthened field validation using React.js and DynamoDB, and optimized system performance through efficient data fetching and API utilization.            </Text>
          </Collapse>
          <Collapse
            title={<Text h4 style={{ color: `${theme.text}` }}>JavaScript</Text>}
          ...
          <Collapse
            title={<Text h4 style={{ color: `${theme.text}` }}>Firebase</Text>}
