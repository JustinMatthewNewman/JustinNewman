    ...
    <div className="max-w-[1380px] mx-auto p-2 grid lg:grid-cols-5 gap-2 py-8">
        ...
        <Card>
          ...
          <CardBody>
            <p style={{ padding: "5px" }}>
              ...
              proven track record of delivering substantial performance gains.
              By harnessing the parallel processing power of NVIDIA GPUs, I can
            ...
            <p style={{ padding: "5px" }}>
              ...
              and apply parallel programming techniques to overcome them. My
              CUDA proficiency can slash processing times, reduce costs, and
              improve product performance. If you&apos;re looking for someone to
              unify the power of your GPUs and spark innovation, I have the
      ...
      <div className="lg:mt-12">
        <Card>
          ...
          <Divider />
          <CardFooter>
            <Link href="https://docs.nvidia.com/cuda/cuda-c-programming-guide/index.html">
