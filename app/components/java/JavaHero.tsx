  ...
  return (
    <div className=" container flex flex-col md:flex-row items-center justify-center mt-12 gap-4 max-w-[1000px]">
      <h2
        ...
        >
        From basic arithmetic to advanced functions, and even fraction manipulation, our {" "}
        <span
          style={{
            backgroundImage:
    ...
    {" "} interface and {" "}
        ...
        {" "} functionality are designed to meet all your mathematical needs with ease and  {" "}
        <span
          style={{
            backgroundImage:
