...
export default function MoreText2() {
  return (
    <div className="container flex flex-col md:flex-row items-center justify-right mt-12 mb-12 gap-4 max-w-[1200px] text-right">
...
, and entertainment, resonating with wisdom that {" "}
    <span
              className="hover:scale-110 ease-in duration-300"
